            ...
            "elements": [
                ...
                },
                {
                    ...
                    "elements": [
                        ...
                        {
                            "type": "checkbox",
                            "name": "038 您对抑郁症诊断、治疗及预后最担心的问题是什么？（最多选三种）",
                            "title": "您对抑郁症诊断、治疗及预后最担心的问题是什么？（最多选三种）",
                            "choices": [
                                "出现药物不良反应",
                                "出现药物依赖",
                                "治疗费用过高，有经济压力",
                        ...
                        },
                        {
                            ...
                            "visibleIf": "{038 您对抑郁症诊断、治疗及预后最担心的问题是什么？（最多选三种）} anyof ['其他']",
                            "title": "其他对抑郁症诊断、治疗及预后最担心的问题："
                        },
                        {
                            "type": "checkbox",
                            "name": "042 您了解的心里治疗方法有哪些？（多选题）",
                            "title": "您了解的心里治疗方法有哪些？（多选题）",
                            "choices": [
                                "支持性心理治疗",
                                "动力学心理治疗",
                                "认知疗法",
                    ...
                    "elements": [
                        {
                            ...
                            "title": "您希望药物治疗后能回归日常生活及社交中，并在其中感受到乐趣、感受到生命有意义、能享受生活",
                            "rateMin": 0,
                            "rateMax": 10,
                        ...
                        },
                        {
                            ...
                            "title": "您希望药物治疗后能改善心境持续低落，如：常哭泣，自我评价低，无助感等症状",
                            "rateMin": 0,
                            "rateMax": 10,
                            "minRateDescription": "非常不迫切",
                            "maxRateDescription": "非常迫切"
        ...
        body: SizedBox(
          ...
          child: Padding(
            ...
            child: s.SurveyWidget(
              survey: Survey.fromJson(jsonDecode(surveyJson)),
              onChange: (v) {
                print(v);
              },
              onSubmit: (v) async {
